...
const Navbar = () => {
  ...
  return (<>
    ...
    <nav
      className={`bg-black backdrop-blur-lg z-[100] mx-auto dark:bg-gray-900 border-b border-slate-950 dark:border-gray-600 shadow-md top-0 sticky transition-all duration-500 ${isSticky
      ...
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
          <div className="lg:block hidden">
            ...
            >
              <Button text="Connect" className="bg-blue-500 text-white hover:bg-blue-600 rounded-full" />
            </a>
          </div>
          <button
        ...
        >
          <ul className="flex flex-col items-start p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-transparent dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            <li>
              <Link
                href="/"
            ...
            <li>
              <div className="relative">
                ...
                >
                  Services
                  <FaAngleDown
                    className={`inline-block w-4 h-4 ml-1 text-gray-500 dark:text-gray-400 ${isDropdownOpen ? "transform rotate-180 transition-all duration-150" : ""
                      }`}
                  />
                </button>
