    ...
    <div className="md:py-12">
      <div className="container mx-auto text-white">
        <h1 className="text-3xl font-semibold mb-6">
          Elevate Your Brand&apos;s Presence with Conture Media
        </h1>
        <ul className="list-none pl-0">
          <IdealForItem description="For Businesses looking to captivate audiences with high-impact, short-form content." />
          ...
          <IdealForItem description="Companies seeking to skyrocket their social media engagement with diverse content crafted for today's quick-scrolling users." />
          ...
          <IdealForItem description="For Leaders searching for a creative agency committed to elevating their brand with exceptional content creation." />
        </ul>
