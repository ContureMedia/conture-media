      ...
      <div className="py-8 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        <div className="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
          ...
          <p className="mb-5 font-light sm:text-xl text-gray-400">
            Here at Conture we focus on brand&apos;s and creator&apos;s
            marketing vision and innovation that can lead to their growth at the
            finest level.
          </p>
        </div>
        <div className="space-y-8 lg:grid lg:grid-cols-3 sm:grid sm:grid-cols-1 md:grid-cols-2 sm:gap-6 xl:gap-10 lg:space-y-0">
          <div className="hover:scale-105 transition-all duration-300 text-white rounded-lg shadow-lg border-2 border-sky-800 flex flex-col gap-5 p-5">
            ...
            <p className="text-center text-sm mb-4">Get Noticed Online</p>
            <p className="flex items-center justify-start text-sm gap-2">
              <IoMdArrowDropright fontSize={19} className="text-green-500" />
              Targeted ads on TikTok, YouTube, Instagram, and more
            </p>
            <p className="flex items-center justify-start text-sm gap-2">
              <IoMdArrowDropright fontSize={19} className="text-green-500" />
              Ad creation that grabs attention
            </p>
            <p className="flex items-center justify-start text-sm gap-2">
              <IoMdArrowDropright fontSize={19} className="text-green-500" />
              Ad optimization for best results
            </p>
            <p className="flex items-center justify-start text-sm gap-2">
              <IoMdArrowDropright fontSize={19} className="text-green-500" />
            ...
            <p className="flex items-center justify-start text-sm gap-2">
              <IoMdArrowDropright fontSize={19} className="text-green-500" />
              Audience targeting to reach your ideal customer
            </p>
            <p className="flex items-center justify-start text-sm gap-2">
              <IoMdArrowDropright fontSize={19} className="text-green-500" />
          ...
          <div className="hover:scale-105 transition-all duration-300 text-white rounded-lg shadow-lg border-2 border-sky-800 flex flex-col gap-5 p-5">
            ...
            <p className="text-center text-sm mb-4">Build a Loyal Community</p>
            <p className="flex items-center justify-start text-sm gap-2">
              <IoMdArrowDropright fontSize={19} className="text-green-500" />
              Community content and conversation strategy
            </p>
            <p className="flex items-center justify-start text-sm gap-2">
              <IoMdArrowDropright fontSize={19} className="text-green-500" />
